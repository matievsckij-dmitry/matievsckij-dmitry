...
<p align="left">Я начинающий Data Scientist. Мой путь в IT началося в мае 2023 года.  Сначала я погрузился в изучение Python,  осваивая основы программирования и Computer Science,  и экспериментировал с разными направлениями в IT. В итоге,  меня  захватила область Data Science.
